    ...
    <style>
        * {
        ...
        .login-container {
            ...
            align-items: center;
            position: relative;
            /* UPDATED: Increased padding-top for better layout */
            padding-top: 90px; 
            overflow-y: auto;
        }
        ...
        /* UPDATED: Changed to space-between for left/right alignment */
        .login-footer {
            position: relative;
            margin-top: 12px;
            width: 100%;
        ...
        .footer-icon {
            ...
            color: #aaa; /* Default color for text */
            gap: 4px;
        }
        
        /* Specific style for Demo button icon */
        #demoAccessLink i {
             color: #007bff; /* Blue color for Demo icon */
        }
        
        /* Specific style for Help Line icon */
        #helpLineLink i {
            color: #28a745; 
        }
        ...
        /* CHANGE: Icon position adjusted from right: 15px to 30px */
        .about-us-icon {
            position: absolute;
            top: 35px; 
            right: 30px; /* MOVED SLIGHTLY LEFT */
            color: #ff4500;
            font-size: 1em;
            cursor: pointer;
            z-index: 10;
        ...
        /* Login Loading Overlay - This overlay is now effectively hidden via JS change */
        .login-loading {
            position: absolute;
            top: 0;
            left: 0;
        ...
        /* Main Application - শুধুমাত্র এটার ব্যাকগ্রাউন্ড সাদা করা হয়েছে */
        #mainApp {
            display: none;
            width: 100%;
            height: 100%;
        ...
        /* Header - Original Design with Exact Border Radius */
        header {
            background-color: #ff4500;
            color: white;
            height: 80px;
            width: 100%;
            text-align: center;
            border-radius: 0 0 80px 0; /* Exact original border radius */
            font-size: 0.85em;
            font-weight: bold;
            display: flex;
            align-items: center;
        ...
        main {
            ...
            justify-content: flex-start;
            width: 100%;
            height: calc(100% - 130px); /* MODIFIED: height calculation reduced to 130px */
            margin-top: 90px; /* MODIFIED: Adjusted margin for header to move content up (from 110px to 90px) */
            position: relative;
            padding: 0 15px;
        }
        ...
        .logo-small img {
            width: 120px; /* MODIFIED: Increased logo size (from 100px) */
            height: auto;
        ...
        .circle {
            width: 240px; /* MODIFIED: Increased circle size (from 200px) */
            height: 240px; /* MODIFIED: Increased circle size (from 200px) */
            border-radius: 50%;
        ...
        /* FIX: সেন্টারিং নিশ্চিত করা হয়েছে */
        .circle-content {
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        /* FIX: Multiplier এর জন্য সেন্টারিং ঠিক করা হয়েছে */
        .multiplier {
            font-size: 2.8em; /* MODIFIED: Adjusted font size for bigger circle (from 2.2em) */
            font-weight: bold;
            color: #ff4500;
            z-index: 4;
        ...
        /* FIX: Loading এর জন্য সেন্টারিং ঠিক করা হয়েছে */
        .loading {
            color: #666;
            font-size: 1.8em; /* MODIFIED: Adjusted font size for bigger circle (from 1.4em) */
            font-weight: bold;
            width: 100%; 
            display: flex; 
            align-items: center;
        ...
        .circle-inner {
            ...
            z-index: 2;
            pointer-events: none;
            /* BLUR EFFECT: Added transition for smooth effect */
            transition: filter 0.5s ease-out, opacity 0.5s ease-out, animation 0.5s linear; /* Added animation to transition */
        }
        
        /* BLUR EFFECT: New class to apply blur */
        .circle-inner.blurred {
            filter: blur(2px) brightness(0.8);
        }
        
        /* --- NEW: Circle Colors and Speed Animation Classes --- */
        ...
        /* 2. Speed Classes (Used by JS) */
        .slow-spin-right {
            animation: rotateRight 15s linear infinite; /* Slower speed */
        }
        .slow-spin-left {
            animation: rotateLeft 20s linear infinite; /* Slower speed */
        }
        .fast-spin-right {
            animation: rotateRight 3s linear infinite; /* Faster speed */
        }
        .fast-spin-left {
            animation: rotateLeft 4s linear infinite; /* Faster speed */
        }

        /* 3. Base Circle Styles with New Red/Orange Colors */
        .circle-right {
            width: 220px; /* MODIFIED: Adjusted inner circle size (from 180px) */
            height: 220px; /* MODIFIED: Adjusted inner circle size (from 180px) */
            border: 5px dashed #ff6347; /* Red/Tomato */
            clip-path: polygon(0 0, 100% 0, 100% 50%, 0 50%);
            opacity: 0.7;
        }
        
        .circle-left {
            width: 200px; /* MODIFIED: Adjusted inner circle size (from 160px) */
            height: 200px; /* MODIFIED: Adjusted inner circle size (from 160px) */
            border: 5px dashed #e03e00; /* Dark Red */
            clip-path: polygon(0 50%, 100% 50%, 100% 100%, 0 100%);
            opacity: 0.7;
        }
        
        .circle-left-3 {
            width: 180px; /* MODIFIED: Adjusted inner circle size (from 140px) */
            height: 180px; /* MODIFIED: Adjusted inner circle size (from 140px) */
            border: 5px dashed #ff4500; /* Main Orange/Red */
            opacity: 0.7;
        }
        /* --- END Circle Styles --- */
        ...
        .next-button:disabled {
            ...
            cursor: not-allowed;
            transform: scale(0.96);
            /* Optional: Add a visual lock effect */
            filter: grayscale(50%); 
        }
        ...
        footer {
            position: fixed; /* ফিক্সড করা হয়েছে */
            bottom: 0;
            width: 100%;
            max-width: 400px; /* কন্টেইনারের সাথে মিল রাখা */
            background-color: #ff4500;
            padding: 8px 0;
        ...
        .timer {
            font-size: 1em; /* ফন্ট সাইজ সামান্য ছোট করা হয়েছে */
            font-weight: bold;
            color: white;
            min-width: 90px; /* আরেকটু বেশি জায়গা */
            text-align: center;
            white-space: nowrap; /* Prevent timer/demo text from wrapping */
        }
        ...
        /* For larger screens - center the 400px container */
        ...
        @media only screen and (max-width: 350px) {
            .circle {
                width: 220px; /* MODIFIED (from 180px) */
                height: 220px; /* MODIFIED (from 180px) */
            }
            
            .circle-right {
                width: 200px; /* MODIFIED (from 160px) */
                height: 200px; /* MODIFIED (from 160px) */
            }
            
            .circle-left {
                width: 180px; /* MODIFIED (from 140px) */
                height: 180px; /* MODIFIED (from 140px) */
            }
            
            .circle-left-3 {
                width: 160px; /* MODIFIED (from 120px) */
                height: 160px; /* MODIFIED (from 120px) */
            }
            
            .multiplier {
                font-size: 2.2em; /* MODIFIED (from 1.8em) */
            }
            
            .logo-small img {
                width: 110px; /* MODIFIED (from 90px) */
            }
            ...
            main {
                margin-top: 80px; /* MODIFIED: Adjusted margin for very small screens (from 100px to 80px) */
                height: calc(100% - 120px); /* MODIFIED: Adjusted height for very small screens (from 140px to 120px) */
            }
            ...
            .login-container {
                padding-top: 80px; /* Adjusting for very small screens */
            }
        ...
        @media only screen and (max-height: 600px) {
            ...
            main {
                height: calc(100% - 120px); /* MODIFIED: Adjusted height for small height screens (from 140px to 120px) */
                margin-top: 80px; /* MODIFIED: Adjusted margin for small height screens (from 100px to 80px) */
            }
            ...
            .circle {
                width: 210px; /* MODIFIED (from 170px) */
                height: 210px; /* MODIFIED (from 170px) */
            }
            
            .circle-right {
                width: 190px; /* MODIFIED (from 150px) */
                height: 190px; /* MODIFIED (from 150px) */
            }
            
            .circle-left {
                width: 170px; /* MODIFIED (from 130px) */
                height: 170px; /* MODIFIED (from 130px) */
            }
            
            .circle-left-3 {
                width: 150px; /* MODIFIED (from 110px) */
                height: 150px; /* MODIFIED (from 110px) */
            }
        ...
        <div id="mainApp">
            ...
            <footer>
                <div class="nav-buttons">
                    <a href="#" class="nav-home" onclick="logout()">
...
<script>
    ...
    const loginLoading = document.getElementById('loginLoading'); // The full overlay element
    const accessKeyInput = document.getElementById('accessKey'); // New reference for input
    ...
    // Show login loading - Only button loading is visible
    function showLoginLoading() {
        loginButton.disabled = true;
        document.querySelector('.button-text').style.display = 'none';
        buttonLoading.style.display = 'flex';
        // loginLoading.style.display = 'flex'; // Full overlay is now hidden as requested
    }
    ...
    function showLoginError(timing) {
        accessKeyInput.style.borderColor = '#ff0000'; // Red border
        errorMessage.style.display = 'block';
        
        setTimeout(() => {
            errorMessage.style.display = 'none';
            accessKeyInput.style.borderColor = '#333'; // Reset border
        }, timing === 'immediate' ? 1500 : 3000); // Shorter duration for immediate errors
    }
    ...
    // Handle user login with key - MODIFIED FOR ERROR/LOADING CONTROL
    function handleLogin() {
        const accessKey = accessKeyInput.value.trim();
        const defaultErrorMessage = 'Invalid or expired access key!';
        errorMessage.textContent = defaultErrorMessage; 
        accessKeyInput.style.borderColor = '#333'; // Reset border color

        // Initial validation: Check if key is entered
        ...
        // Show loading only when starting Firebase check
        showLoginLoading(); 
        ...
        database.ref('keys').once('value').then(snapshot => {
                ...
                Object.keys(keys).forEach(keyId => {
                    ...
                    if (keyData.key === accessKey) {
                        ...
                        if (keyData.expiry > now) { 
                            ...
                            // SUCCESS PATH: Keep loading visible for a small effect
                            setTimeout(() => {
                                hideLoginLoading();
            ...
            if (!keyFound) {
                // FAILURE PATH: Hide loading immediately and show error
                hideLoginLoading(); 
                if (expired) {
            ...
            // ERROR PATH: Hide loading immediately and show error
            hideLoginLoading(); 
    ...
    // Demo Access Function - MODIFIED: Reduced delay
    function handleDemoAccess() {
        clearInterval(timerInterval);
        clearInterval(countdownInterval);
        
        showLoginLoading(); // Only shows button loading
        ...
        setTimeout(() => {
            ...
            toggleCircleBlur(false);
            toggleCircleAnimation(false);
        }, 500); // Reduced delay for faster demo access
    }
    ...
    function loadPredictionSettings() {
        database.ref('predictionSettings').on('value', (snapshot) => {
            ...
            if (settings) {
                ...
                console.log('✅ Current method:', predictionSettings.method);
                console.log('✅ Pattern:', predictionSettings.pattern);
                console.log('✅ Custom messages:', predictionSettings.customMessages);
                console.log('✅ Custom results:', predictionSettings.customResults);
            }
        }, (error) => {
        ...
        countdownInterval = setInterval(() => {
            ...
            if (countdown <= 0) {
                ...
                getPrediction().then(result => {
                    // Check if it's a message or a multiplier
    ...
    // Get prediction based on selected method - MODIFIED FOR DEMO RANDOM
    function getPrediction() {
        return new Promise((resolve, reject) => {
            
            // --- NEW: Demo Mode Check for Random Results ---
            if (demoModeActive) {
                // Generates a random multiplier between 1.01x and 9.99x
    ...
    function logout() {
        ...
        accessKeyInput.style.borderColor = '#333'; // Reset input border on logout
        currentKey = null;
        keyExpiry = null;
